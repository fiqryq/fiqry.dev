...
export const timeline = [
  {
    id: 1,
    content: 'Internship as',
    target: 'Game Developer at Inovasi Semesta Ilmu (INOSI)',
    href: 'https://www.linkedin.com/company/inosibusiness/',
    date: 'Jan 2018 - Feb 2018',
    icon: logourl.logoInosi.link,
    iconBackground: 'bg-white drop-shadow-md',
    jobDescription: ['Developed an augmented reality virtual tour of Bandung.']
  },
  {
    id: 2,
    content: 'Internship as',
    target: 'Assets Manager at Vallet',
    href: 'https://www.linkedin.com/company/vallet/',
    date: 'Jan 2020 - Apr 2020',
    icon: logourl.logoValet.link,
    iconBackground: 'bg-white drop-shadow-md',
    jobDescription: [
  ...
  },
  {
    id: 3,
    content: 'Working as',
    target: 'Frontend Enginner at Telkom University (PUTI)',
    href: 'https://www.linkedin.com/school/telkom-university/',
    date: 'Mar 2021 - Apr 2022',
    icon: logourl.logoTelkom.link,
    iconBackground: 'bg-white drop-shadow-md',
    jobDescription: [
  ...
  },
  {
    ...
    icon: logourl.logoBlocknom.link,
    iconBackground: 'bg-white drop-shadow-md',
    jobDescription: [
  ...
  },
  {
    id: 6,
    content: 'Working as',
    target: 'Frontend Enginner at Kitabisa',
    href: 'https://www.linkedin.com/company/kita-bisa/',
    date: 'May 2022 - Present',
    icon: logourl.logoKitabisa.link,
    iconBackground: 'bg-white drop-shadow-md',
    jobDescription: [
